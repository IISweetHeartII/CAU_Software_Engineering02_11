...
public class BoardTest {
    ...
    void getPositionByMoveCountTest() {
        ...
        // n == 1
        Position resultPosition = board.getPositionByMoveCount(startPosition, 1);
        ...
        resultPosition = board.getPositionByMoveCount(startPosition, 5);
        assertNotNull(resultPosition);  // null이 아닌지 확인
        assertEquals(expectedPosition, resultPosition);  // 예상 위치와 일치하는지 확인
        ...
        expectedPosition = new Position("P6");
        resultPosition = board.getPositionByMoveCount(startPosition, 2);
        assertNotNull(resultPosition);  // null이 아닌지 확인
        assertEquals(expectedPosition, resultPosition);  // 예상 위치와 일치하는지 확인
        expectedPosition = new Position("E1");
        resultPosition = board.getPositionByMoveCount(startPosition, 1);
        resultPosition = board.getPositionByMoveCount(resultPosition, 1);
        assertNotNull(resultPosition);  // null이 아닌지 확인
        assertEquals(expectedPosition, resultPosition);  // 예상 위치와 일치하는지 확인
